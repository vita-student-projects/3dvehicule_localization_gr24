...
class KITTISingleObject:
    def __init__(self, parsed_line: str, calib: KITTICalibration,nuscenes:bool):
    ...
    def projected_center(self) -> np.ndarray:
        ...
        if self.base_cam == 2 and self.nuscenes==False:
...
class KITTIMultiObjects:
    ...
    @staticmethod
    def get_objects_from_label(label_file: str, calibration: KITTICalibration,nuscenes):
        with open(label_file, 'r') as f:
            lines = f.readlines()
        objects = [KITTISingleObject(line, calibration,nuscenes) for line in lines]
